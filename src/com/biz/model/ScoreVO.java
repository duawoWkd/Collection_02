...
public class ScoreVO {
	...
	/*
	 * vo 패턴 특징 
	 * 1. 멤버변수(필드)는 꼭 필요한 용도가 아니면 대체로 private으로 선언을 한다.
	 * 2. 멤버변수를 외부에서 접근(저장, 읽기)할수 있도록 getter 와 setter method를 생성해서 사용한다. 
	 *     	== 데이터의 은닉(감추기)해서 데이터를 보호하는 목적 
	 * 3. toString() method를 재 정의(Override)해서 필드에 저장된 값을 외부에서 확인할수 있도록 한다.
	 */
	private String number; // strNmuber
